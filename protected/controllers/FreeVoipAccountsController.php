...
class FreeVoipAccountsController extends Controller
{
	/**
	...
	{
		$model=new FreeVoipAccounts;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FreeVoipAccounts']))
		{
			$model->attributes=$_POST['FreeVoipAccounts'];
			if($model->save())
	...
	{
		$model=new FreeVoipAccounts('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FreeVoipAccounts']))
			$model->attributes=$_GET['FreeVoipAccounts'];
	 ...
	 * @param FreeVoipAccounts $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='free-voip-accounts-form')
		{
